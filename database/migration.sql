...
ALTER SEQUENCE bad_habits_id_seq RESTART WITH 1;
...
INSERT INTO bad_habits (title) VALUES
    ('Курение в помещении'),
    ('Громкие ночные звонки'),
    ('Непунктуальность в оплате'),
    ...
    ('Частые вечеринки'),
    ('Долгий душ'),
    ('Не чистит за питомцем'),
    ('Громкие утренние сборы'),
    ('Непредсказуемые гости'),
    ('Ночная готовка'),
    ('Игнорирует температурный режим'),
    ('Критикует других'),
    ('Громкий храп'),
    ('Не закрывает двери'),
    ('Копит посуду в комнате'),
    ('Ночная стирка'),
    ('Экономия на свете'),
    ('Готовит острую еду'),
    ('Использует чужую косметику'),
    ('Переставляет мебель'),
    ('Нерегулярная уборка'),
    ('Крошки повсюду'),
    ('Частые жалобы'),
    ('Неправильная сортировка мусора'),
    ('Постоянно просит в долг');
